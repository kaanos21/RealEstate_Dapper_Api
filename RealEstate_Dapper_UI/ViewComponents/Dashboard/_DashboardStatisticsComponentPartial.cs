...
namespace RealEstate_Dapper_UI.ViewComponents.Dashboard
{
    public class _DashboardStatisticsComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:7275/api/Statistic/ProductCount");
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:7275/api/Statistic/EmployeeNameByMaxProductCount\r\n");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:7275/api/Statistic/DifferentCityCount");
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:7275/api/Statistics/AverageProductPriceByRent");
